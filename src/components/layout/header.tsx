    ...
    <div className="bg-white">
      <header className="top-0 left-0 w-full z-50 bg-gradient-to-tl from-black/15 to-transparent">
        <nav className="max-w-7xl mx-auto p-4 flex justify-between items-center">
          {/* Logo */}
          <img
            src="/logo-rosangela.svg"
            alt="Rosângela Constelação Sistêmica"
            className="h-15"
          />

          {/* Links desktop */}
          <ul className="hidden md:flex gap-6 px-2 text-purple-900 items-center text-lg">
            <a href="#sobre" className="hover:text-purple-700">
              O que é
            </a>
            <a href="#leis" className="hover:text-purple-700">
              Leis Sistêmicas
            </a>
            <a href="#como-funciona" className="hover:text-purple-700">
              Como funciona
            </a>
            <a href="#beneficios" className="hover:text-purple-700">
              Transformações
            </a>
            <a href="#questions-frequency" className="hover:text-purple-700">
              FAQ
            </a>
          </ul>
