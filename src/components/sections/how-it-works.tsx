    ...
    >
      <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 sm:grid-cols-3">
        <Card icon={CalendarDays} title="Antes da sessão">
          Escolha um ambiente calmo (para online), prefira computador se
          possível, tenha água, papel e caneta.
        </Card>
        <Card icon={Sparkles} title="Durante a sessão">
          Recursos como bonecos, cristais, cartas ou constelação na água —
